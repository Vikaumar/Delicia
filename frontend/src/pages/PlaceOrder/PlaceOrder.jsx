...
const PlaceOrder = () => {
    ...
    const { getTotalCartAmount, getFinalTotal, token, food_list, cartItems, url, setCartItems } = useContext(StoreContext);
  ...
  try {
    ...
    let orderData = {
      address: data,
      items: orderItems,
      amount: getFinalTotal(), // ✅ use promo + delivery fee aware
    };
